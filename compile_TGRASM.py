...
def check(number):
 if str(number)[:2] == "0x":
  ...
  try:
   ...
   print("Invalid Value given: \""+str(number)+"\"... if this is hex, please provide 0x at the start of the value")
   sys.exit()
...
if len(sys.argv) < 2:
 ...
 for i in range(len(asm)):
  ...
  if len(line) < 1: print("[line: "+str(i+1)+"\t| "+str(address)+"/"+hex(address)+"\t] *LINE FLAGED AS UN-USABLE BY FIRST SCAN*"); continue
  elif ":" in line[0]:
   if "{" in line[0]:
  ...
  if line[0] in instructions:
   ...
   if line[0] == "raw":
    if len(args) != 6:
     print("ERROR at line "+str(i+1)+": the instruction \"RAW\" requres 6 arguments, got "+str(len(args)))
     exit(-1)
    j=0
    try:
     while j<7:
   ...
   if line[0] == "mov":
    ...
    if "[" in args[1]:
     ...
     if reg(args[1]) < 0:
      out+=[0x00,combinetochar(reg(args[0]),0),0x00,0x00,(check(args[1])&0x000FF00)>> 8,check(args[1])&0x00000FF]
     else:
...
#     print("ERROR at line "+str(i+1)+": was expecting REG or Value for IMM but is invalid (got \""+args[1]+"\")"); exit(-1)
   ...
   if line[0] == "lmov":
    ...
    if "[" in args[2]:
     ...
     out+=[0x00,combinetochar(reg(args[0]),0),0x00,0x00,(check(args[2])&0x000FF00)>> 8, check(args[2])&0x00000FF]
     out+=[0x00,combinetochar(reg(args[1]),0),0x00,0x00,(check(args[2])&0xF000000)>>24,(check(args[2])&0x0FF0000)>>16]
    address+=6 # takes up 2 instuctions(12 bytes)
   
   if line[0] == "add":
    if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
    if reg(args[1]) < 0:
     out+=[0x01,combinetochar(reg(args[0]),0),combinetochar(reg(args[2]),0),0x00,(check(args[1])&0x0000FF00)>>8,check(args[1])&0x000000FF]
    else:
   ...
   if line[0] == "sub":
    if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
    if reg(args[1]) < 0:
     out+=[0x02,combinetochar(reg(args[0]),0),combinetochar(reg(args[2]),0),0x00,(check(args[1])&0x0000FF00)>>8,check(args[1])&0x000000FF]
    else:
   ...
   if line[0] == "mul":
    if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
    if reg(args[1]) < 0:
     out+=[0x03,combinetochar(reg(args[0]),0),combinetochar(reg(args[2]),0),0x00,(check(args[1])&0x0000FF00)>>8,check(args[1])&0x000000FF]
    else:
   ...
   if line[0] == "div":
    if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
    if reg(args[1]) < 0:
     out+=[0x04,combinetochar(reg(args[0]),0),combinetochar(reg(args[2]),0),0x00,(check(args[1])&0x0000FF00)>>8,check(args[1])&0x000000FF]
    else:
   ...
   if line[0] == "and" or line[0] == "band":
    if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
    if reg(args[1]) < 0:
     out+=[0x05,combinetochar(reg(args[0]),0),combinetochar(reg(args[2]),0),0x00,(check(args[1])&0x0000FF00)>>8,check(args[1])&0x000000FF]
    else:
   ...
   if line[0] == "or" or line[0] == "bor":
    if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
    if reg(args[1]) < 0:
     out+=[0x06,combinetochar(reg(args[0]),0),combinetochar(reg(args[2]),0),0x00,(check(args[1])&0x0000FF00)>>8,check(args[1])&0x000000FF]
    else:
   ...
   if line[0] == "xor" or line[0] == "bxor":
    if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
    if reg(args[1]) < 0:
     out+=[0x07,combinetochar(reg(args[0]),0),combinetochar(reg(args[2]),0),0x00,(check(args[1])&0x0000FF00)>>8,check(args[1])&0x000000FF]
    else:
   ...
   if line[0] == "bsl":
    ...
    out+=[0x08,combinetochar(reg(args[0]),0),combinetochar(reg(args[2]),0),0x00,(check(args[1])&0x0000FF00)>>8,check(args[1])&0x000000FF]
   
   if line[0] == "bsr":
    if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
    if reg(args[2]) > 0: print("ERROR at line "+str(i+1)+"[2]: Value for IMM is invalid (got \""+args[2]+"\")"); exit(-1)
    out+=[0x09,combinetochar(reg(args[0]),0),combinetochar(reg(args[2]),0),0x00,(check(args[1])&0x0000FF00)>>8,check(args[1])&0x000000FF]
   ...
   if line[0] == "split":
    ...
    out+=[0x0B,combinetochar(reg(args[0]),reg(args[1])),combinetochar(reg(args[2]),0),0x00,0x00,check(args[3])]
   ...
   if line[0] == "combine":
    ...
    if reg(args[2]) < 0: print("ERROR at line "+str(i+1)+"[2]: REG value for B is invalid (got \""+args[2]+"\")"); exit(-1)
    if reg(args[3]) > 0: print("ERROR at line "+str(i+1)+"[3]: Value for IMM is invalid (got \""+args[3]+"\")"); exit(-1)
    out+=[0x0C,combinetochar(reg(args[0]),reg(args[1])),combinetochar(reg(args[2]),0),0x00,0x00,check(args[3])]
   ...
   if line[0] == "cmpeq":
    if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
    if reg(args[1]) < 0:
     out+=[0x0F,combinetochar(reg(args[0]),0),0x10,0x00,(check(args[1])   &0x000FF00)>>8,check(args[1])   &0x00000FF]
    else:
   ...
   if line[0] == "cmplt":
    if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
    if reg(args[1]) < 0:
     out+=[0x10,combinetochar(reg(args[0]),0),0x10,0x00,(check(args[1])&0x000FF00)>>8,check(args[1])&0x00000FF]
    else:
   ...
   if line[0] == "cmpgt":
    if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
    if reg(args[1]) < 0:
     out+=[0x11,combinetochar(reg(args[0]),0),0x10,0x00,(check(args[1])&0x000FF00)>>8,check(args[1])&0x00000FF]
    else:
     out+=[0x11,combinetochar(reg(args[0]),reg(args[1])),0x00,0x00,0x00,0x00]
   
   if line[0] == "rpos":
    if reg(args[0]) < 0:
     out+=[0x12,0x00,combinetochar(0x1,(check(args[0])&0xF000000)>>24),(check(args[0])&0x0FF0000)>>16,(check(args[0])&0x000FF00>>8),check(args[1])&0x00000FF]
    else:
     if reg(args[1]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for B is invalid (got \""+args[1]+"\")"); exit(-1)
     out+=[0x12,combinetochar(reg(args[0]),reg(args[1])),0x00,0x00,0x00,0x00]
   
   if line[0] == "wram":
    if len(args) == 2:
     if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
     if reg(args[1]) >-1: print("ERROR at line "+str(i+1)+"[1]: REG value for B is invalid (got \""+args[1]+"\")"); exit(-1)
     out+=[0x13,combinetochar(reg(args[0]),0),combinetochar(1,(check(args[1])&0xF000000)>>24),(check(args[1])&0x0FF0000)>>16,(check(args[1])&0x000FF00)>>8,check(args[1])&0x00000FF]
    elif len(args) == 1:
     if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
   ...
   if line[0] == "rram":
    if len(args) == 2:
     if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
     if reg(args[1]) >-1: print("ERROR at line "+str(i+1)+"[1]: REG value for B is invalid (got \""+args[1]+"\")"); exit(-1)
     out+=[0x14,combinetochar(reg(args[0]),0),combinetochar(1,(check(args[1])&0xF000000)>>24),(check(args[1])&0x0FF0000)>>16,(check(args[1])&0x000FF00>>8),check(args[1])&0x00000FF]
    elif len(args) == 1:
     if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
   ...
   if line[0] == "wvram":
    if len(args) == 2:
     if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
     if reg(args[1]) >-1: print("ERROR at line "+str(i+1)+"[1]: REG value for B is invalid (got \""+args[1]+"\")"); exit(-1)
     out+=[0x13,combinetochar(reg(args[0]),1),combinetochar(1,(check(args[1])&0xF000000)>>24),(check(args[1])&0x0FF0000)>>16,(check(args[1])&0x000FF00)>>8,check(args[1])&0x00000FF]
    elif len(args) == 1:
     if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
     out+=[0x13,combinetochar(reg(args[0]),1),0x00,0x00,0x00,0x00]
    else:
     print("ERROR at line "+str(i+1)+": the instruction \"WVRAM\" requres 1 or 2 arguments, got "+str(len(args)))
   
   if line[0] == "rvram":
    if len(args) == 2:
     if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
     if reg(args[1]) >-1: print("ERROR at line "+str(i+1)+"[1]: Value for IMM is invalid (got \""+args[1]+"\")"); exit(-1)
     out+=[0x14,combinetochar(reg(args[0]),1),combinetochar(1,(check(args[1])&0xF000000)>>24),(check(args[1])&0x0FF0000)>>16,(check(args[1])&0x000FF00)>>8,check(args[1])&0x00000FF]
    elif len(args) == 1:
     if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
     out+=[0x14,combinetochar(reg(args[0]),1),0x00,0x00,0x00,0x00]
    else:
     print("ERROR at line "+str(i+1)+": the instruction \"RVRAM\" requres 1 or 2 arguments, got "+str(len(args)))
   ...
   if line[0] == "rsav":
    if len(args) == 3:
     ...
     if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
     if reg(args[1]) >-1: print("ERROR at line "+str(i+1)+"[1]: Value for IMM is invalid (got \""+args[1]+"\")"); exit(-1)
     out+=[0x16,combinetochar(reg(args[0]),1),combinetochar(1,(check(args[1])&0xF000000)>>24),(check(args[1])&0x0FF0000)>>16,(check(args[1])&0x000FF00)>>8,check(args[1])&0x00000FF]
    else:
     print("ERROR at line "+str(i+1)+": the instruction \"RSAV\" requres 2 or 3 arguments, got "+str(len(args)))
   ...
   if line[0] == "wsav":
    if len(args) == 3:
     ...
     if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
     if reg(args[1]) >-1: print("ERROR at line "+str(i+1)+"[1]: Value for IMM is invalid (got \""+args[1]+"\")"); exit(-1)
     out+=[0x18,combinetochar(reg(args[0]),1),combinetochar(1,(check(args[1])&0xF000000)>>24),(check(args[1])&0x0FF0000)>>16,(check(args[1])&0x000FF00)>>8,check(args[1])&0x00000FF]
    else:
     print("ERROR at line "+str(i+1)+": the instruction \"RSAV\" requres 2 or 3 arguments, got "+str(len(args)))
   ...
   if line[0] == "rrom":
    if len(args) == 3:
     ...
     if reg(args[1]) >-1: print("ERROR at line "+str(i+1)+"[1]: Value for IMM is invalid (got \""+args[1]+"\")"); exit(-1)
     args[1] = check(args[1])
     out+=[0x1A,combinetochar(reg(args[0]),0),combinetochar(0,(check(args[1])&0xF000000)>>24),(check(args[1])&0x0FF0000)>>16,(check(args[1])&0x000FF00)>>8,check(args[1])&0x00000FF]
    else:
     print("ERROR at line "+str(i+1)+": the instruction \"RROM\" requres 2 or 3 arguments, got "+str(len(args)))
   ...
   if line[0] == "disp":
    if len(args) == 1:
     ...
     if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
     if reg(args[1]) < 0: print("ERROR at line "+str(i+1)+"[1]: REG value for B is invalid (got \""+args[1]+"\")"); exit(-1)
     out+=[0x1C,combinetochar(reg(args[0]),reg(args[1])),0x00,0x00,0x00,0x01]
    elif len(args) == 3:
     if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
     if reg(args[1]) < 0: print("ERROR at line "+str(i+1)+"[1]: REG value for B is invalid (got \""+args[1]+"\")"); exit(-1)
     if reg(args[2]) < 0: print("ERROR at line "+str(i+1)+"[2]: REG value for C is invalid (got \""+args[2]+"\")"); exit(-1)
   ...
   if line[0] == "dsend":
    ...
    else:                    tmp = combinetochar(0x0,check(args[1]))
    out+=[0x1E,combinetochar(reg(args[0]),0),0x00,0x00,tmp,check(args[2])%0x100]
   ...
   if line[0] == "drecv":
    ...
    out+=[0x1F,combinetochar(reg(args[0]),0),0x00,0x00,tmp,check(args[2])%0x100]
   ...
   if line[0] == "exec":
    if reg(args[0]) >-1: print("ERROR at line "+str(i+1)+"[0]: Execute Index for A is invalid (got \""+args[0]+"\")"); exit(-1)
    if reg(args[1]) >-1: print("ERROR at line "+str(i+1)+"[1]: Value for IMM is invalid (got \""      +args[1]+"\")"); exit(-1)
    ...
    args[1] = check(args[1])
    out+=[0x22,combinetochar(tmp,0),combinetochar(0,(check(args[1])&0xF000000)>>24),(check(args[1])&0x0FF0000)>>16,(check(args[1])&0x000FF00)>>8,check(args[1])&0x00000FF]
   ...
   if line[0] == "rbios":
    if len(args) == 3:
     ...
     if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
     if reg(args[1]) >-1: print("ERROR at line "+str(i+1)+"[1]: Value for IMM is invalid (got \""+args[1]+"\")"); exit(-1)
     out+=[0x24,combinetochar(reg(args[0]),0),combinetochar(0,(check(args[1])&0xF000000)>>24),(check(args[1])&0x0FF0000)>>16,(check(args[1])&0x000FF00)>>8,check(args[1])&0x00000FF]
    else:
     print("ERROR at line "+str(i+1)+": the instruction \"RBIOS\" requres 2 or 3 arguments, got "+str(len(args)))
   
   if line[0] == "push":
    if reg(args[0]) >-1: out+=[0x26,combinetochar(reg(args[0]),0x00),0x00,0x00,0x00,0x00]
    else:                out+=[0x26,0x01,combinetochar(0,(check(args[1])&0xF000000)>>24),(check(args[1])&0x0FF0000)>>16,(check(args[1])&0x000FF00)>>8,check(args[1])&0x00000FF]
   ...
   if line[0] == "gclk":
    ...
    if reg(args[0]) < 0: print("ERROR at line "+str(i+1)+"[0]: REG value for A is invalid (got \""+args[0]+"\")"); exit(-1)
    if args[1] == "1" or args[1] == "reset": out+=[0x2A,combinetochar(reg(args[0]),0x1),0x00,0x00,0x00,0x00]
    else:                                    out+=[0x2A,combinetochar(reg(args[0]),0x0),0x00,0x00,0x00,0x00]
   
   if line[0] == "wait":
    out+=[0x2B,0x00,combinetochar(0x0,(check(args[0])&0xF000000)>>24),(check(args[0])&0x0FF0000)>>16,(check(args[0])&0x000FF00)>>8,check(args[0])&0x00000FF]
